...
if "df_jogos_selecionados" not in st.session_state or time.time() - st.session_state["last_loaded"] > 600:
    df_jogos_selecionados = load_data()
    st.session_state["df_jogos_selecionados"] = df_jogos_selecionados
